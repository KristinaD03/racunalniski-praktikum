...
tip \texttt{(npr. bool v C++)}, kjer bi vrednost \texttt{true} predstavljala
...
\noindent prepoteni in izčrpani študentje težko sledili tempu pouka.
%
...
gostom za mizo. S tem imamo v mislih grafični uporabniški vmesnik \texttt{(Graphical
