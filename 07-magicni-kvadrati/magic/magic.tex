...
% Konec magičnega kvadrata
 ...
 \begin{definicija}
   ...
   \begin{equation}
      \label{eq:numbers}%oznaka: eq:numbers
...
\begin{table}[!ht]
   \centering
   \caption{Magični kvadrat na Sgradi Familiji}
   \label{table:sagrada}
   \large
   \begin{tabular}{|c|c|c|c|}\hline
    1 & 14 & 14 &  4 \\\hline
...
\[\m(n;A,D) = \frac{n}{2}\bigl(2A+(n^2-1)D\bigr).\]
...
\begin{table}[h!]
 ...
 \begin{tabular}{lcccccc}
   ...
   \midrule
   red & 1 & 2 & 3 & 4 & 5 & 6\\   
    število kvadratov & 51 & 0 & 1 & 880 & 275305224 & \((1,7745 \pm 0,0016)10^{19}\) \\
   \bottomrule
 \end{tabular}
\end{table}
% Konec tabele
...
% - oznaka: table:mag5
\begin{magic}{5}{Magični kvadrat reda 5}{table:mag5}\hline
...
% - oznaka: table:mag6
\begin{magic}{9}{Magični kvadrat reda 6}{table:mag6}\hline
...
% - oznaka: table:mag9
\begin{magic}{9}{Magični kvadrat reda 9}{table:mag9}\hline
