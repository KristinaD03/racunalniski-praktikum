...
\DeclareMathOperator{\M}{Lin\{\mathit{v}\}}

\begin{document}
\title{Nekaj o inavriantnih podprostorih}
...
Primer: če je \(v\in V\) lastni vektor preslikave $L$ za lastno vrednost \(\lambda\), je prostor 
\(U = \M\) invarianten podprostor linearne preslikave $L$.
