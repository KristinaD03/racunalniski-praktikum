...
ki jo v enačbah \eqref{eq:1} in \eqref{eq:2} izračunamo za sode in lihe vrednosti $r$.
...
Za lihe vrednosti $r$ se \(\iam{r}\) izračuna kot: 
\begin{equation}
    \label{eq:2}
...
Za sode vrednosti $r$ se pa \(\iam{r}\) izračuna kot: 
% začetek enačbe
 \begin{align}
     \lambda_r(p)&=
...
\begin{figure}[ht!]
\centering
 \subfigure[Prevojne točke Galamovega modela s petimi enakomerno porazdeljenimi skupinami za različne vrednosti $k$.]{
    \includegraphics[width=0.4\textwidth]{a515.png}
    \label{fig:a515}
    }
 \hfill
 \subfigure[Prevojne točke Galamovega modela s šestimi enakomerno porazdeljenimi skupinami za različne vrednosti $k$.]{
...
\bibitem{galam2015stubbornness}
S. Galam\textit{Stubbornness as an unfortunate key to win a public debate: an illustration from sociophysics},Springer-Verlag Berlin Heidelberg, Fbruary 2015.
\bibitem{galam2016trump}
S. Galam The Trump phenomenon: An explanation from sociophysics,\textit{International Journal of Modern Physics B},September 2016.
\bibitem{galam2020tipping}
S. Galam Tipping Points in Opinion Dynamics: A Universal Formula in Five Dimensions, November 2020.
\end{thebibliography}
